...
software_name=Sponge-Minecraft-Server
container_name=minecraft-sponge-server
image_name=theprojectsix/minecraftsponge-server:1.12.2-stable
restart_type=always

main_mountpoint=/srv/minecraft-sponge-1.12.2
main_port=25565
